...
================================================================================
Deep learning application for pneumonia detection in chest X-rays
...
Model Performance: 94.48% Validation Accuracy
================================================================================
"""
...
def load_model():
    ...
    model_path = Path(__file__).parent / 'models' / 'resnet50_best.pth'
    ...
    if uploaded_file is not None:
        ...
        if st.button("🔬 Analyze X-Ray", type="primary"):
            with st.spinner("Analyzing image..."):
                ...
                with col1:
                    st.metric(label="NORMAL", value=f"{results['normal_prob']:.2f}%")
                
                with col2:
                    st.metric(label="PNEUMONIA", value=f"{results['pneumonia_prob']:.2f}%")
                ...
                if results['prediction'] == 'NORMAL':
                    ...
                    **Normal X-Ray Detected**
                    ...
                    The model has classified this X-ray as NORMAL with {results['confidence']:.2f}% confidence.
                    ...
                    **Pneumonia Detected**
                    ...
                    The model has detected signs of pneumonia with {results['confidence']:.2f}% confidence.
